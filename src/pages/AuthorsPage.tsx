      ...
      <section id="author-bios" className="container">
        ...
        <div className="authors-grid mb-2">
          <div className="author-card">
            ...
            <p>
              Frank Herbert was an American science fiction author best known
              for the 1965 novel Dune and its five sequels. Herbert's work is
              known for its complex plots, political intrigue, and ecological
              themes.
            </p>
          ...
          <div className="author-card">
            ...
            <p>
              Brian Herbert is the son of Frank Herbert and has continued the
              Dune saga with Kevin J. Anderson. He has co-authored numerous Dune
              novels and maintains the legacy of his father's universe.
            </p>
            <div className="author-achievements">
